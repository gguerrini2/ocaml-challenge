...
It accepts an optional function and maps it to an optional argument. If there is no function, the result is `None`, otherwise the result is the same as 
[`option_map`](/2/option-map/README.md).
